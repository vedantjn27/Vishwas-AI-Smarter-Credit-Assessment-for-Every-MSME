...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-driven Financial Health Card for MSMEs — alternate data, near real-time scoring, ULI/OCEN/AA ready." },
      { property: "og:title", content: "Vishwas AI — Trust in MSME Credit" },
      { property: "og:description", content: "Multidimensional MSME financial health, powered by alternate data and AI." },
